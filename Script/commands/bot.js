...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "ALVI") || (event.body.toLowerCase() == "ALVI VAI") || (event.body.toLowerCase() == "@ALVI ッ") || (event.body.toLowerCase() == "আলভী")) {
  ...
  if ((event.body.toLowerCase() == "আ্ঁল্ঁভি্ঁর্ঁ ব্ঁউ্ঁ  জা্ঁন্স্ঁ") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস আলভী এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "mim") || (event.body.toLowerCase() == "আ্ঁল্ঁভি্ঁর্ঁ ব্ঁউ্ঁ  জা্ঁন্স্ঁ")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস আলভী এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
